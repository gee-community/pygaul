...
**pyGAUL** uses `nox <https://nox.thea.codes/en/stable/>`__ to automate several development-related tasks.
...
This will install the **pyGAUL** library, together with two additional tools:
